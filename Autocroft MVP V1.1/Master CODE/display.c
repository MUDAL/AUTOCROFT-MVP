										...
										
{
	...
	*/
	...
	LCD_SetCursor(0,0);
	LCD_PrintString(firstRowHeading);
	Conv_IntegerToString(row1Data,strData1);
	LCD_PrintString(strData1);
	LCD_PrintChar(measurementUnit1);
	...
	LCD_SetCursor(1,0);
	LCD_PrintString(secondRowHeading);
	Conv_IntegerToString(row2Data,strData2);
	LCD_PrintString(strData2);
	LCD_PrintChar(measurementUnit2);
}
	...
	*/
	...
	switch(displayMode)
	{
		case SUBSTATE_HIGHLIGHT_MIN:
			...
			LCD_PrintString(strMin);
			LCD_PrintChar(measurementUnit);
			//bottom
			LCD_SetCursor(1,3);
			LCD_PrintString(secondRowHeading);
			Conv_IntegerToString(maxValue,strMax);
			LCD_PrintString(strMax);
			LCD_PrintChar(measurementUnit);
			break;
